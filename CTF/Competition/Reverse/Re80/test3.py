...
def decrypt_xxtea(ciphertext_base64, key_str):
    # Base64解码（需验证是否为标准Base64）
...
if __name__ == "__main__":
    target = "u4jdb+9UH2RXBYKYjjKfA4OrmQvuikG89aXT5G+a1dhncN6QxzL6SA=="
    key = "flag{123456}"
    
    try:
        flag = decrypt_xxtea(target, key)
        print(f"解密结果: {flag}")
